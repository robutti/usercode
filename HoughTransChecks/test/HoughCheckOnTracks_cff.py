...
process.houghcheck = cms.EDAnalyzer('HoughCheckOnTracks',
        ...
        maxAbsDoca = cms.untracked.double(20.),
        nBinsDoca = cms.untracked.int32(2),
        maxAbsKappa = cms.untracked.double(0.0024),
        nBinsKappa = cms.untracked.int32(24),
        nBinsPhi = cms.untracked.int32(30),
        maxAbsZ0 = cms.untracked.double(100.),
        nBinsZ0 = cms.untracked.int32(20),
        maxAbsLambda = cms.untracked.double(1.4),
        nBinsLambda = cms.untracked.int32(24),
        projectionPars = cms.untracked.int32(0),
